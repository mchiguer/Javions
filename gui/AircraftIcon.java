...
public enum AircraftIcon {
    ...
    /**
     * @param typeDesignator         représente l'indicateur de type de l'aéronef
     * @param typeDescription        représente la description de l'aéronef
     * @param category               représente la catégorie
     * @param wakeTurbulenceCategory représente la catégorie de turbulence de sillage d'un aéronef
     * @return
     */
    ...
    /**
     * Cette méthode public verifie si l'icône peut être tournée afin d'indiquer le cap de l'aéronef
     *
     * @return vrai ssi l'icône peut (et doit) être tournée
     */
    ...
    /**
     * Cette méthode public retourne le chemin SVG de l'icone
     *
